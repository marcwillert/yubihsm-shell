...
install_name_tool -change "$BREW_LIB/openssl@3/lib/libcrypto.3.dylib" "@loader_path/../lib/libcrypto.3.dylib" "$OUTPUT/bin/yubihsm-auth"

install_name_tool -rpath "$OUTPUT/lib" "@loader_path/../lib" "$OUTPUT/bin/yubihsm-shell"
install_name_tool -rpath "$OUTPUT/lib" "@loader_path/../lib" "$OUTPUT/bin/yubihsm-wrap"
install_name_tool -rpath "$OUTPUT/lib" "@loader_path/../lib" "$OUTPUT/bin/yubihsm-auth"
